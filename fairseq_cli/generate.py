...
def _main(args, output_file):
    ...
    models, _model_args = checkpoint_utils.load_model_ensemble(       # 会把原model 的generator给build一遍
    ...
    # print("before build generator")
    generator = task.build_generator(models, args)
    # print("after build generator")
    ...
    for sample in progress:
        ...
        # print(sample)  # 到这都和训练时validate时sample一样
        # print(hypos)
        ...
        for i, sample_id in enumerate(sample['id'].tolist()):
            ...
            # hypo['tokens'] 和训练时valid时生成的是一样的，但是decode方式不同
