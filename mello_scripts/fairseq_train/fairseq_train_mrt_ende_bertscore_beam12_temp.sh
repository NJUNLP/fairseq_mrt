...
# bash mello_scripts/fairseq_train/fairseq_train_mrt_ende_bertscore_beam12_temp.sh &> checkpoints/wmt14_en2de_bleu_beam12_lr5e-4_temp/wmt14_en2de_bleu_beam12_lr5e-4_temp.log