...
# bash mello_scripts/fairseq_train/fairseq_train_mrt_ende_comet_beam12_temp.sh &> checkpoints/wmt14_en2de_comet_beam12_lr5e-4_temp/wmt14_en2de_comet_beam12_lr5e-4_temp.log