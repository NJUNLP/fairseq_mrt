...
# bash mello_scripts/fairseq_train/fairseq_train_ende_bleurt_sample_plus_beam.sh &> checkpoints/wmt14_en2de_bleurt_sample_top10_step1_plus_beam12_lr5e-4/wmt14_en2de_bleurt_sample_top10_step1_plus_beam12_lr5e-4.log