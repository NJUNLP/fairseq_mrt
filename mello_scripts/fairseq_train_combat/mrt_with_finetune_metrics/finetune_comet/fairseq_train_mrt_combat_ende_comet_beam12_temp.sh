...
# bash mello_scripts/fairseq_train_combat/mrt_with_finetune_metrics/fairseq_train_mrt_combat_ende_comet_beam12_temp.sh &> checkpoints/wmt14_en2de_comet_beam12_lr5e-4/wmt14_en2de_comet_beam12_lr5e-4.log