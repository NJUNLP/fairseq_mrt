...
fairseq-train \
    ...
    --arch transformer \
    -s en -t de \
    --save-dir checkpoints/wmt14_en2de_unite_ref_beam12_lr5e-4_interval10_v1 \
...
# bash mello_scripts/fairseq_train_combat/mrt_with_finetune_metrics/finetune_unite_ref/fairseq_train_mrt_combat_ende_unite_ref_beam12_debug.sh
