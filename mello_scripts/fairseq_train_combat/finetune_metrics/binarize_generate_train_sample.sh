...
split_code=/opt/tiger/fake_arnold/fairseq_mrt/mello_scripts/fairseq_train_combat/finetune_metrics/split_hyp_from_fairseq_generate_command.py
python3 $split_code --prefix $mt_save_path

# bash mello_scripts/fairseq_train_combat/finetune_metrics/binarize_generate_train_sample.sh