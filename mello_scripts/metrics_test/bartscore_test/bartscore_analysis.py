...
# plot_path_prefix = '/opt/tiger/fake_arnold/fairseq_mrt/mello_scripts/analysis/poor_robustness_bartscore/'
# plot_attribution(sent=sent_tokens, attr=attr, plot_path_prefix=plot_path_prefix)

# python3 mello_scripts/metrics_test/bartscore_test/bartscore_test.py
