...
save_num_dict['en2zh_BARTScore'] = 37
...
plt.savefig('mrt_analysis_results/all_plot/mrt_test_plot_metrics_' + lang + '.png')

# python3 mello_scripts/analysis/plot_metrics_change_update.py
