...
save_csv_path = path_prefix + "/all_metrics_change_stat/stat_metrics_change_" + lang + ".csv"
...
for metric_id in range(7):
    metric = metrics[metric_id]
    info_prefix = path_prefix + '/' + lang + '_' + metric
    ...
    info_line = [metric, bleu_list[0], bertscore_list[0], bartscore_list[0], bleurt_list[0], comet_list[0], unite_ref_list[0], unite_src_ref_list[0]]
    max_idx = 0
    ...
    print(lang + '_' + metric + '_max_step: %d' % (max_idx * 50))
    for i in range(7):
...
# python3 mello_scripts/analysis/metrics_change_stat.py
