...
# cal bleu
echo "#=========================== cal BLEU ===========================#"
python3 mello_scripts/metrics_test/bleu_test/cal_bleu_file_1.5.1_command.py --st $st --ed $ed --len $len --beam $beam --generate_path $generate_path
...
python3 mello_scripts/analysis/plot_metrics_change_command.py --ed 100 --len 3 --lang en2de --this_metric BLEURT --generate_prefix checkpoints/wmt14_en2de_cased_bleurt_beam12_lr5e-4_base_bleu26.11_continue_meters
...
# bash mello_scripts/tool/bash_test.sh