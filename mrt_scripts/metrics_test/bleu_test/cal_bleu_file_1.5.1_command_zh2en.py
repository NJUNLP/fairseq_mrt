...
for step in steps:
    ...
    command = 'python3 mrt_scripts/analysis/split_hyp_from_fairseq_generate_command.py --prefix ' + fairseq_generate_prefix.rstrip('/')
    os.system(command)
...
# python3 mrt_scripts/metrics_test/bleu_test/cal_bleu_file_1.5.1_command_zh2en.py
