...
# bash mrt_scripts/fairseq_train/fairseq_train_mrt_enzh_bleu_beam12_temp.sh > checkpoints/en2zh_ldc_bleurt_beam12_lr5e-4_temp/en2zh_all_split5_04_bleurt_beam12_lr5e-4.log