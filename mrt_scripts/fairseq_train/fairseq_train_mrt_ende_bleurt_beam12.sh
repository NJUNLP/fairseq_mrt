...
# bash mrt_scripts/fairseq_train/fairseq_train_mrt_ende_bleurt_beam12.sh > checkpoints/wmt14_en2de_bleurt_beam12_lr5e-4/wmt14_en2de_bleurt_beam12_lr5e-4.log