...
parser = argparse.ArgumentParser(description="plot metrics change")
parser.add_argument('--ed', type=int)
parser.add_argument('--len', type=int)
parser.add_argument('--lang', type=str)
parser.add_argument('--this_metric', type=str)
parser.add_argument('--generate_prefix', type=str)
args = parser.parse_args()

lang = args.lang
metric = args.this_metric   # 'bleurt'
csv_prefix = args.generate_prefix
...
plt.savefig(csv_prefix + '/mrt_' + lang + '_' + metric + '_plot_metrics.jpg')

# python3 mrt_scripts/analysis/plot_metrics_change.py