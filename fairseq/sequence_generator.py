...
class SequenceGenerator(nn.Module):
    def __init__(
        ...
        search_strategy=None,            # 这里 search_strategy 就是 search.py 文件里的各个类 BeamSearch Sampling 啥的
        eos=None,
    ):
    ...
    def _generate(
        ...
        src_tokens = encoder_input["src_tokens"].to(next(self.model.parameters()).device)
        ...
        for step in range(max_len + 1):  # one extra step for EOS marker
            ...
            if step >= max_len:
                ...
                # https://github.com/pytorch/fairseq/issues/2286
                lprobs[:, self.eos] = 1
            ...
            cand_scores, cand_indices, cand_beams = self.search.step(    # 这里调用不同的解码策略比如 beam search sampling 前进一步
                step,
